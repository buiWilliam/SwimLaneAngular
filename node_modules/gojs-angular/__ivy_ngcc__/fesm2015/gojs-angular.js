...
DiagramComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: DiagramComponent, selectors: [["gojs-diagram"]], viewQuery: function DiagramComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { linkDataArray: "linkDataArray", modelData: "modelData", modelChangedListener: "modelChangedListener", initDiagram: "initDiagram", nodeDataArray: "nodeDataArray", divClassName: "divClassName" }, outputs: { modelChange: "modelChange" }, decls: 2, vars: 2, consts: [["ngDiagram", ""]], template: function DiagramComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", null, 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵclassMap(ctx.divClassName);
    } }, encapsulation: 2 });
/** @nocollapse */
...
PaletteComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: PaletteComponent, selectors: [["gojs-palette"]], viewQuery: function PaletteComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { linkDataArray: "linkDataArray", modelData: "modelData", modelChangedListener: "modelChangedListener", initPalette: "initPalette", nodeDataArray: "nodeDataArray", divClassName: "divClassName" }, outputs: { modelChange: "modelChange" }, decls: 2, vars: 2, consts: [["ngPalette", ""]], template: function PaletteComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", null, 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵclassMap(ctx.divClassName);
    } }, encapsulation: 2 });
...
OverviewComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: OverviewComponent, selectors: [["gojs-overview"]], viewQuery: function OverviewComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { observedDiagram: "observedDiagram", initOverview: "initOverview", divClassName: "divClassName" }, features: [ɵngcc0.ɵɵNgOnChangesFeature()], decls: 2, vars: 2, consts: [["ngOverview", ""]], template: function OverviewComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", null, 0);
    } if (rf & 2) {
        ɵngcc0.ɵɵclassMap(ctx.divClassName);
    } }, encapsulation: 2 });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(GojsAngularModule, { declarations: [DiagramComponent,
        OverviewComponent,
